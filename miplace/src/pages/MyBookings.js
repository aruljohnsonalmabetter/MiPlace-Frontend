...
function MyBookings() {
  return (
    <div>
          <div class="flex justify-between mx-[3.125rem]  font-mullish space-x-4 border-solid border-2 border-indigo-600">
            <div>
         ...
         <Bookingreceipt/>
          <div class="mx-[3.125rem] font-mullish my-[2.125rem] border-solid border-2 border-red-600">
          ...
          <div class="mx-[3.125rem] font-mullish border-solid border-2 border-green-600">
